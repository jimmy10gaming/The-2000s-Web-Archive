...
function ProgressBar(elementId, config) {
    ...
    if (this.orientation == ProgressBar.Orientation.Horizontal && this.borderRadius > this.height / 2) this.borderRadius = Math.round(this.height / 2);
    if (this.orientation == ProgressBar.Orientation.Vertical && this.borderRadius > this.width / 2) this.borderRadius = Math.round(this.width / 2);
...
ProgressBar.prototype.finishLoading = function () {
    if (!this.image.width || !this.image.width) return;
    var tempStyle = "";
    ...
    for (i = 0; i < borderRadiusCheck.length; i++) {
        ...
        if (temp || typeof temp == "string") break
    }
    if (temp != "" && ProgressBar._parseInt(temp) != this.borderRadius) this.borderRadius = ProgressBar._parseInt(temp);
    ...
    if (this.displayType == 0) {
        ...
        if (this.orientation == ProgressBar.Orientation.Horizontal) {
            if (this.image.width < this.borderRadius) this.borderRadius = this.image.width;
            if (this.borderRadius > this.width / 2) this.borderRadius = this.width
        } else if (this.orientation == ProgressBar.Orientation.Vertical) {
            if (this.image.height < this.borderRadius) this.borderRadius = this.image.height;
            if (this.borderRadius > this.height / 2) this.borderRadius = this.height
        }
    ...
    if (this.backgroundUrl != '') this.backgroundElement.style.backgroundImage = "url('" + this.backgroundUrl + "')";
    this.backgroundElement.style.position = "relative";
    if (this.displayType == 0) this.backgroundElement.style.width = (this.width + this.borderWidth.left + this.borderWidth.right) + "px";
    ...
    if (this.markerUrl != '') this.markerElement.style.backgroundImage = "url('" + this.markerUrl + "')";
...
ProgressBar.prototype.setValue = function (newValue) {
    if (newValue !== null && newValue < this.minValue) newValue = this.minValue;
    if (newValue !== null && newValue > this.maxValue) newValue = this.maxValue;
    if (newValue !== null && this.animationSmoothness != ProgressBar.AnimationSmoothness.None) {
        if (this.animation.smoothTimerId != null) clearInterval(this.animation.smoothTimerId);
        this.animation.smoothProgressSteps = [];
        var temp = this.value;
        var i = newValue - this.value,
            j = 0;
        while (Math.abs(i) > 1) {
            if (this.animationSmoothness == ProgressBar.AnimationSmoothness.Smooth1) {
                j = i / 2;
                if (Math.abs(j) > Math.abs(this.maxValue - this.minValue) * 0.1) j = (j > 0 ? 1 : -1) * Math.abs(this.maxValue - this.minValue) * 0.1
                ...
                j = i / 4;
                if (Math.abs(j) > Math.abs(this.maxValue - this.minValue) * 0.2) j = (j > 0 ? 1 : -1) * Math.abs(this.maxValue - this.minValue) * 0.2
            } else {
                break
            }
    ...
    if (newValue === null) {
        if (this.animation.smoothProgressSteps.length > 0) this.value = this.animation.smoothProgressSteps.pop();
        if (this.animation.smoothProgressSteps.length == 0 && this.animation.smoothTimerId != null) clearInterval(this.animation.smoothTimerId)
    } else {
        this.value = newValue
    }
    if (this.isLoaded) {
        ...
        if (this.orientation == ProgressBar.Orientation.Horizontal) {
            ...
            if (progress > 0) {
                ...
                if (this.animationStyle != ProgressBar.AnimationStyle.None) this.markerElement.style.visibility = "visible"
            } else {
                this.markerElement.style.width = this.width + "px";
                if (this.animationStyle != ProgressBar.AnimationStyle.StaticFull && this.animationStyle != ProgressBar.AnimationStyle.CustomFull) this.markerElement.style.visibility = "hidden"
            }
            if (this.animationStyle != ProgressBar.AnimationStyle.StaticFull && this.animationStyle != ProgressBar.AnimationStyle.CustomFull) {
                if (this.direction == ProgressBar.Direction.LeftToRight) {
                    this.markerElement.style.left = this.borderWidth.left + "px"
        ...
        if (this.showLabel) {
            ...
            if (this.labelText != "") {
                ...
                if (tempLabelText.indexOf("{value") != -1) {
                    var i = 0;
                    while (tempLabelText.indexOf("{value}") != -1) tempLabelText = tempLabelText.replace("{value}", this.value);
                    while (tempLabelText.indexOf("{value,") != -1) {
                        ...
                        if (parseInt(decimalDigits) > 0) {
                            ...
                            if (replaceWith.indexOf(".") == -1) replaceWith += ".";
                            var currentDigits = replaceWith.substr(replaceWith.indexOf(".") + 1).length;
                            if (currentDigits < parseInt(decimalDigits)) for (i = currentDigits; i < parseInt(decimalDigits); i++) replaceWith += "0"
                        } else {
                ...
                while (tempLabelText.indexOf("{progress}") != -1) tempLabelText = tempLabelText.replace("{progress}", Math.round((this.value / this.maxValue) * 100));
...
ProgressBar.prototype.setLabel = function (lbl) {

     this.textElement.innerHTML = lbl;
};
...
ProgressBar.prototype.setAnimationStyle = function (style) {
    ...
    if (this.animationStyle == ProgressBar.AnimationStyle.Flickering1 || this.animationStyle == ProgressBar.AnimationStyle.Flickering2 || this.animationStyle == ProgressBar.AnimationStyle.Flickering3) {
        this.markerElement.style.backgroundRepeat = "repeat";
        this.animation.markerPosition = 0;
        this.animation.opacity = 0.5
    } else if (this.animationStyle == ProgressBar.AnimationStyle.LeftToRight1 || this.animationStyle == ProgressBar.AnimationStyle.LeftToRight2 || this.animationStyle == ProgressBar.AnimationStyle.RightToLeft1 || this.animationStyle == ProgressBar.AnimationStyle.RightToLeft2 || this.animationStyle == ProgressBar.AnimationStyle.TwoWay) {
        if (this.animationStyle == ProgressBar.AnimationStyle.LeftToRight1 || this.animationStyle == ProgressBar.AnimationStyle.RightToLeft1 || this.animationStyle == ProgressBar.AnimationStyle.TwoWay) {
    ...
    if (this.animation.timerId != null) clearInterval(this.animation.timerId);
    this.setValue(this.value);
    if (this.onAnimationStyleChanged) this.onAnimationStyleChanged();
    if (this.animationStyle != ProgressBar.AnimationStyle.None) {
        var that = this;
        this.animation.timerId = setInterval(function () {
            that.blink()
        }, this.animationInterval)
    }
};
ProgressBar.prototype.blink = function () {
    ...
    if (this.animationStyle == ProgressBar.AnimationStyle.Flickering1 || this.animationStyle == ProgressBar.AnimationStyle.Flickering2 || this.animationStyle == ProgressBar.AnimationStyle.Flickering3) {
        var params = null;
        if (this.animationStyle == ProgressBar.AnimationStyle.Flickering1) params = {
            step: 0.05,
            growSpeed: 3,
            decSpeed: 1,
            maxOpacity: 0.75,
        ...
        if (this.animationStyle == ProgressBar.AnimationStyle.Flickering2) params = {
            step: 0.05,
            growSpeed: 1,
            decSpeed: 1,
            maxOpacity: 0.75,
        ...
        if (this.animationStyle == ProgressBar.AnimationStyle.Flickering3) params = {
            step: 0.05,
            growSpeed: 1,
            decSpeed: 3,
            maxOpacity: 0.75,
        ...
        if (this.animation.opacity >= params.maxOpacity || this.animation.opacity <= params.minOpacity) {
            ...
            if (this.animation.opacity > params.maxOpacity) this.animation.opacity = params.maxOpacity;
            if (this.animation.opacity < params.minOpacity) this.animation.opacity = params.minOpacity
        }
        this.markerElement.style.opacity = this.animation.opacity
    } else if (this.animationStyle == ProgressBar.AnimationStyle.LeftToRight1 || this.animationStyle == ProgressBar.AnimationStyle.LeftToRight2 || this.animationStyle == ProgressBar.AnimationStyle.RightToLeft1 || this.animationStyle == ProgressBar.AnimationStyle.RightToLeft2 || this.animationStyle == ProgressBar.AnimationStyle.TwoWay) {
        if (this.orientation == ProgressBar.Orientation.Horizontal) {
            if (this.animationStyle == ProgressBar.AnimationStyle.LeftToRight1 || this.animationStyle == ProgressBar.AnimationStyle.LeftToRight2) {
                ...
                if (this.animation.markerPosition > this.width * 2) this.animation.markerPosition = -this.image.width
                ...
                this.animation.markerPosition -= 20 * this.animationSpeed;
                if (this.animation.markerPosition < -this.image.width) this.animation.markerPosition = this.width * 2
                ...
                if (this.animation.markerPosition >= this.progressPosition - this.borderRadius * 2 || this.animation.markerPosition <= -this.borderRadius * 20) this.animation.markerDirection = -this.animation.markerDirection
            }
            this.markerElement.style.backgroundPosition = (this.animation.markerPosition) + "px 0px"
        } else {
            if (this.animationStyle == ProgressBar.AnimationStyle.LeftToRight1 || this.animationStyle == ProgressBar.AnimationStyle.LeftToRight2) {
                this.animation.markerPosition += 20 * this.animationSpeed;
                if (this.animation.markerPosition > this.height * 2) this.animation.markerPosition = -this.image.height
            } else if (this.animationStyle == ProgressBar.AnimationStyle.RightToLeft1 || this.animationStyle == ProgressBar.AnimationStyle.RightToLeft2) {
                this.animation.markerPosition -= 20 * this.animationSpeed;
                if (this.animation.markerPosition < -this.image.height) this.animation.markerPosition = this.height * 2
            } else if (this.animationStyle == ProgressBar.AnimationStyle.TwoWay) {
                this.animation.markerPosition += 20 * this.animationSpeed * this.animation.markerDirection;
                if (this.animation.markerPosition >= this.progressPosition - this.borderRadius * 2 || this.animation.markerPosition <= -this.borderRadius * 20) this.animation.markerDirection = -this.animation.markerDirection
            }
...
ProgressBar._elementCurrentStyle = function (element, styleName) {
    if (element.currentStyle) {
        var i = 0,
            temp = "",
            changeCase = false;
        for (i = 0; i < styleName.length; i++) if (styleName[i] != '-') {
...
/*
     FILE ARCHIVED ON 15:38:38 Apr 26, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:03:01 Nov 22, 2025.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 8.827
  LoadShardBlock: 94.511 (3)
  PetaboxLoader3.datanode: 168.883 (5)
  load_resource: 245.722 (2)
  PetaboxLoader3.resolve: 141.903 (2)
*/